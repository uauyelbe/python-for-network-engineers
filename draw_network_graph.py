...
import sys
from ospf_topology import parse_ospf_topology
...
parse = parse_ospf_topology()

def draw_topology(parse, output_filename='topology'):
    ...
    nodes = set([
        ...
        for item in list(parse.keys()) + list(parse.values())
...
draw_topology(parse, output_filename='topology')